...
#  <% tp.date.now("YYYY") %>
==> [[770 🌏Years|🌏 Years Dashboard]]Quarters:: [[<% tp.date.now("YYYY") %>-Q1]],  [[<% tp.date.now("YYYY") %>-Q2]], [[<% tp.date.now("YYYY") %>-Q3]], [[<% tp.date.now("YYYY") %>-Q4]]
...
-  [ ] Complete "End of [[700 ⭕Cycles/770 🌏Years/2022]] Reflection"
...
## Update [[305🧭 Guiding Principles|🧭 Guiding Principles]]
- [ ] Updated
...
- [ ] Review Habits & Routines
    - **Consider**
        ...
        - Bad habits to avoid
        - Weekly practices
- [ ] Revise [[130 🌟Value Goals|🌟Value Goals]] and  [[150 🎯Outcomes|🎯Outcomes]]
- [ ] Establish/Prioritize [[170 💎Projects|💎Projects]] in pursuit of Goals
