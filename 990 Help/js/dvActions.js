...
class DvActions {
        ...
        return createButton({
            ...
            clickOverride: {
                ...
                params: [{
                    ...
                    dv,
                    project,
                    filePath: `100 🗻Action Pyramid/320 🛠 Actions/${luxon.DateTime.now().toFormat("yyyyMMddHHmmss")}.md`,
                    contents: "",
                    split: true
                }]
            }
    ...
    getNoteLiteratureStatusButtons(args) {
        const {Constants, ObsidianUtils} = customJS;
        const {
            that,
            objective,
        ...
        let statusButtons = [];
        for (const status of Constants.noteLiterature.status.orderedMap.keys()) {
            statusButtons.push(createButton({
                app,
                el: that.container,
                args: {
                ...
                clickOverride: {
                    click: ObsidianUtils.updateNoteLiteratureStatus,
                    params: [{
                        objective,
                        update,
                        luxon,
